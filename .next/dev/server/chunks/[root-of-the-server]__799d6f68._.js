...
async function GET() {
    try {
        ...
        const offers = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TEACHING_OFFERS_COLLECTION"]).find({
            userId
        }).toArray();
        const connectionsCount = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTIONS_COLLECTION"]).countDocuments({
            teacherId: userId,
            status: "active"
        });
        const completedSessions = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSIONS_COLLECTION"]).find({
            teacherId: userId,
            status: "completed"
        }).toArray();
        ...
        const now = new Date();
        const upcomingSessions = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSIONS_COLLECTION"]).find({
            teacherId: userId,
            scheduledAt: {
                $gte: now
            },
        ...
        const pendingMatches = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTIONS_COLLECTION"]).find({
            teacherId: userId,
            status: "pending"
        }).limit(10).toArray();
        ...
        const sessionsFormatted = await Promise.all(upcomingSessions.map(async (s)=>{
            const student = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["USERS_COLLECTION"]).findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](s.studentId)
            });
            return {
                id: s._id?.toString(),
        ...
        const pendingFormatted = await Promise.all(pendingMatches.map(async (p)=>{
            const student = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["USERS_COLLECTION"]).findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](p.studentId)
            });
            return {
                id: p._id?.toString(),
                studentName: student?.name || "Student",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__799d6f68._.js.map