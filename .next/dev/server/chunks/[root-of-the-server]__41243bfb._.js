...
async function GET() {
    try {
        ...
        const connections = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTIONS_COLLECTION"]).find({
            studentId: userId,
            status: "active"
        }).toArray();
        ...
        const sessionsFormatted = await Promise.all(upcomingSessions.map(async (s)=>{
            const teacher = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["USERS_COLLECTION"]).findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](s.teacherId)
            });
            return {
                id: s._id?.toString(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41243bfb._.js.map