...
"[project]/app/api/chat/conversations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const messages = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MESSAGES_COLLECTION"]).find({
            $or: [
                {
                    senderId: userId
                },
        ...
        const users = otherUserIds.size > 0 ? await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["USERS_COLLECTION"]).find({
            _id: {
                $in: Array.from(otherUserIds).map((id)=>new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](id))
            }
        }).toArray() : [];
        ...
        if (includeUserId && __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"].isValid(includeUserId) && String(includeUserId) !== userId) {
            const already = conversations.some((c)=>c.userId === includeUserId);
            if (!already) {
                const user = await db.collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["USERS_COLLECTION"]).findOne({
                    _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](includeUserId)
                });
                if (user) {
                    const u = user;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a4c10704._.js.map